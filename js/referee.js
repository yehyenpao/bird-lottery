const Referee = {
    ...
    renderScoreboard() {
        ...
        const colorA = CONFIG.TEAM_COLORS[this.currentMatch.A隊名] || "#4a90e2"; // 預設藍色
        const colorB = CONFIG.TEAM_COLORS[this.currentMatch.B隊名] || "#ff4d4f"; // 預設紅色
    ...
    toggleFullscreen() {
        ...
        // 如果進入全螢幕，嘗試請求瀏覽器全螢幕 (可選，視環境支援)
        if (isFull && scoreboard.requestFullscreen) {
            // scoreboard.requestFullscreen().catch(e => console.log("Fullscreen API blocked"));
        }
    },
